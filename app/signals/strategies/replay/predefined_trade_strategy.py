...
class PredefinedTradeStrategy(Strategy):
    ...
    def init(self):
        super().init()
        self.trade_schedule = _parsed_schedule
...
def backtest(df, trade_schedule, cash=100000, margin=1/500):
    ...
    PredefinedTradeStrategy.trades_actions = []
    PredefinedTradeStrategy.executed_trades = set()
