...
class MessageEncoder(json.JSONEncoder):
    def default(self, obj):
        ...
        if hasattr(obj, "content") or (hasattr(obj, "__class__") and "Message" in obj.__class__.__name__):
...
async def chatbot(request: MessageRequest):
    try:
        ...
        async def event_generator():
            ...
            async for event in get_chatbot_response_stream(user_input=user_input, thread_id=thread_id):
                try:
